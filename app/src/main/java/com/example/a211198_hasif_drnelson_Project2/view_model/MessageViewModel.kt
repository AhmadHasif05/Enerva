...
class MessageViewModel : ViewModel() {
    ...
    // Just the group chats — used by SearchScreen's "Group" tab.
    ...
    // Create a group chat from a set of friends. A group is just a Conversation
    // keyed by the group name, seeded with a system-style opening message.
    // No-op for a blank name, no members, or a name that already exists.
