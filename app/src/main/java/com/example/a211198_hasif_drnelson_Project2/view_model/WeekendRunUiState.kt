...
sealed interface WeekendRunUiState {
    ...
    data class Success(val routes: List<RunRoute>) : WeekendRunUiState   // live OpenStreetMap data
    data class Fallback(val routes: List<RunRoute>) : WeekendRunUiState  // offline/no-results samples
}
